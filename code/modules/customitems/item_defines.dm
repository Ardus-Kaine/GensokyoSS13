...
/obj/item/clothing/suit/storage/fluff/lombardi
	...
	desc = "A dark blue, martian-pattern, EMS jacket. It sports high-visibility reflective stripes, a star of life on the back, and has a nametag on the right side of the chest that is too worn to be read."
	icon = 'icons/obj/custom_items.dmi'

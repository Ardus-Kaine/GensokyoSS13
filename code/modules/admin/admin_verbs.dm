...
//	/client/proc/check_antagonists,		//shows all antags,
	...
	/client/proc/scrub_toxins,			//scrubs out free toxins,
	/client/proc/toggle_explosions,			//enables or disables explisions,
	/client/proc/set_who_info			//changes how much information is shown by the 'who' verb

...
////////////////The following is the same rocket code but in a different directory so as to comply with the syndiacte's 'Shoot' proc\\\\\\\\\\\\\\\

/obj/item/projectile/carrot
	name = "Carrot"
	desc = "Oh SHIT!"
...
/obj/item/weapon/gun/rocketlauncher/carrot
	name = "carrot launcher"
	desc = "Happy Easter!"
	icon = 'icons/mob/bunn.dmi'
	icon_state = "carrot_launcher"
	projectile = /obj/item/projectile/carrot
	max_rockets = 20


/obj/item/weapon/gun/rocketlauncher/carrot/full
	name = "carrot launcher"
	desc = "Happy Easter!"
	icon = 'icons/mob/bunn.dmi'
	icon_state = "carrot_launcher"
...
/obj/item/weapon/gun/launcher/rocket/carrot
	name = "carrot launcher"
	desc = "Happy Easter!"
	icon = 'icons/mob/bunn.dmi'
	icon_state = "carrot_launcher"
...
/obj/item/weapon/gun/launcher/rocket/carrot/full
	name = "carrot launcher"
	desc = "Happy Easter!"
	icon = 'icons/mob/bunn.dmi'
	icon_state = "carrot_launcher"
